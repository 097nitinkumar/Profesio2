...
if(isset($_POST['login'])) 
{
    ...
    $check_database_query = mysqli_query($con, "SELECT * FROM `administration` WHERE `email_db`='$mail_id' AND `password_db` ='$password' and `active_db`='1'");
    ...
    header('location: ./../session.php');
       ...
       echo 'Incorrect Details or account not activated';
    }
}
