...
//`age_db`,`gender_db`,`image_loc`,`deleted`,`deactivated`
		...
		$query0 = "INSERT into `employee` (`emp_id_db`, `first_name_db`, `last_name_db`,`experience_db`, `dob_db`, `address_db`, `city_db`,`telephone_db`,`profession_db`,`charges_db`,`age_db`,`gender_db`,`image_loc`,`deleted`,`deactivated`)";
		$query0 .= " Values  ('$user_id','$f_name', '$l_name','$experience','$dob', '$address', '$city','$phone_no','$profession','$charges','0','male','./assets/images/profile_pics/defaults/head_emerald.png','no','no')";		   
		...
		$username=$f_name.'_'.$l_name.'_'.$user_id;
