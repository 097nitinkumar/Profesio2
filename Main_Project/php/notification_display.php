    ...
    $S_var=$user_id;
    $query="SELECT * FROM  `notification` WHERE `user_to_db`='$S_var'  and `is_notification_db`='yes' order BY `date_time_db` DESC";
    //SELECT * FROM  `notification` WHERE `user_to_db` like '%c%'  and `is_notification_db`='yes' order BY `date_time_db` DESC
