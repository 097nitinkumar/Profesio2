...
} else 
{
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
    {
        ...
        $fdir="./uploads/".$_SESSION['username_session'].$hash.".".$imageFileType;
        $store_db=$fdir;
        //echo $fdir;
		$fdir="./uploads/".$_SESSION['username_session'].$hash.".".$type;
		//echo $fdir; 
		rename("./uploads/".basename($_FILES["fileToUpload"]["name"]),$fdir);
		//
        $fname=$_SESSION['username_session'].$hash.".".$imageFileType;
        //echo $fname;
        //echo $imageFileType;
        //Execute the query
        //$user_id='2080';
        ...
        //$proff = $row['profession_db'];
        //$img_loc = $row['image_loc'];
        $store_db="./assets/images/uploads/".$_SESSION['username_session'].$hash.".".$imageFileType;
        echo $store_db;
        ...
        $_SESSION['e_image_loc_session_logged_in']=$store_db;
        ...
        //echo $new_file_dir;
        $check_database_query = mysqli_query($con, "UPDATE `client` SET `cust_id_db`='$user_id',`first_name_db`='$fname',`last_name_db`='$lname',`email_db`='$mail_id',`pass_db`='$password',`dob_db`='$dob',`city_db`='$city',`telephone_db`='$telno',`profession_db`='$proff',`image_loc`='$store_db' WHERE `cust_id_db`='$user_id'");
        $_SESSION['c_image_loc_session_logged_in']=$store_db;
        }
        ...
        $store_db1="./assets/images/uploads/".$_SESSION['username_session'].$hash.".".$imageFileType;
        //$new_file_dir="<br><br><br><br>".$fdir."_____________".$img_loc."<br><br><br><br>".$store_db;
        //echo $new_file_dir;
