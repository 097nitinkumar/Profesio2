...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<?php 
		...
		//$Task_count='80';
		//$Upvotes='100';	 
		echo '<input type="hidden" value='.$employee_id.' id="user_id_feeds">'?>
...
<?php
 		...
 		<div class="profile_info">
 			...
 			<p>Services done: <?php echo  $rating; ?>
      		...
      		<?php echo "<br><p>Behaviour:".$behaviour."</p><br><p>Punctuality:".$punctuality."</p>"."<br><p>Working skill:".$working_skill."</p><br><p>Charges:".$employee_charges."</p><br>" ?>
		...
		else 
		{
		 ...
		 echo '<a href="./profile_employee_message.php" style="width: 90%;
			height: 5%;
			border: none;
			border-radius: 3px;
			...
			echo' <br><br><form action="review.php" method="GET">
...
<b>Recent Posts...</b>:<br>
	...
	<div id="review_feeds">
		...
		{	echo '<b>Reviews...</b>';
			while($person2=mysqli_fetch_array($records2))
			{
				echo '<hr><br><div class="main_column column" style="width: 100%;height:50%;">
						<br>'.$person2['Comment'].'
						<hr>'.$person2['timestamp'].'
						<!--<br>-->
					</div>';
			}	
		}
